...
import com.miekir.mvp.view.base.BasicActivity
import com.miekir.mvp.view.base.BasicFragment
 ...
 */
inline fun <reified V : IView, reified P : BasePresenter<V>> IView.lazy(owner: ViewModelStoreOwner? = null, key: String? = null) = lazy(LazyThreadSafetyMode.NONE) {
    val presenter: P
    if (owner != null) {
